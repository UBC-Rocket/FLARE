...
//     void
//     setLowTempC(float temperature); // Sets T_LOW (degrees C) alert threshold
//     void
//     setHighTempC(float temperature); // Sets T_HIGH (degrees C) alert threshold
//     void
//     setLowTempF(float temperature); // Sets T_LOW (degrees F) alert threshold
//     void
//     setHighTempF(float temperature); // Sets T_HIGH (degrees F) alert threshold
...
//     // 1 - Thermostat Mode: Active when temp > T_HIGH until any read operation
//     // occurs
