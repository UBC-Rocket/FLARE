...
enum class Pin {
    ...
    BUZZER = 41, // PB15
    DROGUE_IGNITOR = 14, // IGN1_1 - PB9
    DROGUE_CONTINUITY_READ = 2, // IGN_CHK1 - PA10
    MAIN_IGNITOR = 4, // IGN2_1 - PB5
    MAIN_CONTINUITY_READ = 8, // IGN_CHK2 - PA9
    BACKUP_IGNITOR = 16, // IGN3_1 - PC10
    BACKUP_CONTINUITY_READ = 7, // IGN_CHK3 - PA8
