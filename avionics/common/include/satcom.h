 ...
 * @description   Initializes the satcom module.  Sends a message over SatCom
 * when the SatComSend function is called.  This source utilizes the
 * IridiumSBD.cpp and .h files also included in this distro.
 *
 * @section LICENSE
