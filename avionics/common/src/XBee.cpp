...
uint8_t ZBExplicitRxResponse::getDataOffset() { return 17; }
...
//		int width = 0;
//
//		// width of sample depends on how many I/O pins are enabled. add one for
// each analog that's enabled 		for (int i = 0; i <= 5; i++) { 			if
//(isAnalogEnabled(i)) {
...
uint8_t *RemoteAtCommandResponse::getValue() {
    if (getValueLength() > 0) {
        // value is only included for query commands.  set commands does not
        // return a value
...
void XBeeResponse::getAtCommandResponse(XBeeResponse &atCommandResponse) {
    ...
    AtCommandResponse *at =
        static_cast<AtCommandResponse *>(&atCommandResponse);
...
void XBee::readPacket() {
    ...
    while (available()) {
        ...
        if (_pos > 0 && b == START_BYTE && ATAP == 2) {
            // new packet start before previous packeted completed -- discard
            // previous packet and start over
        ...
        default:
            ...
            // packet length does not include start, length, or checksum bytes,
            // so add 3
            if (_pos == (_response.getPacketLength() + 3)) {
                ...
                // minus 4 because we start after start,msb,lsb,api and up to
                // but not including checksum e.g. if frame was one byte, _pos=4
                // would be the byte, pos=5 is the checksum, where end stop
                // reading
                ...
                // add to packet array, starting with the fourth byte of the
                // apiFrame
...
ZBTxRequest::ZBTxRequest(const XBeeAddress64 &addr64, uint16_t addr16,
...
ZBTxRequest::ZBTxRequest(const XBeeAddress64 &addr64, uint8_t *data,
                         uint8_t dataLength)
...
unsigned short ZBTxRequest::getFrameDataLength() {
...
ZBExplicitTxRequest::ZBExplicitTxRequest(XBeeAddress64 &addr64, uint16_t addr16,
                                         uint8_t broadcastRadius,
                                         uint8_t option, uint8_t *payload,
                                         uint8_t payloadLength, uint8_t frameId,
                                         uint8_t srcEndpoint,
                                         uint8_t dstEndpoint,
                                         uint16_t clusterId, uint16_t profileId)
    : ZBTxRequest(addr64, addr16, broadcastRadius, option, payload,
                  payloadLength, frameId) {
...
unsigned short ZBExplicitTxRequest::getFrameDataLength() {
    return ZB_EXPLICIT_TX_API_LENGTH + getPayloadLength();
}

uint8_t ZBExplicitTxRequest::getSrcEndpoint() { return _srcEndpoint; }

uint8_t ZBExplicitTxRequest::getDstEndpoint() { return _dstEndpoint; }

uint16_t ZBExplicitTxRequest::getClusterId() { return _clusterId; }

uint16_t ZBExplicitTxRequest::getProfileId() { return _profileId; }
...
unsigned short Tx16Request::getFrameDataLength() {
...
unsigned short Tx64Request::getFrameDataLength() {
...
unsigned short AtCommandRequest::getFrameDataLength() {
...
unsigned short RemoteAtCommandRequest::getFrameDataLength() {
...
void XBee::send(XBeeRequest &request) {
    ...
    // send length
    short frameDataLength = request.getFrameDataLength();
...
uint8_t XBeeWithCallbacks::waitForInternal(uint8_t apiId, void *response,
                                           uint16_t timeout, void *func,
                                           uintptr_t data, int16_t frameId) {
    unsigned long start = millis();
    do {
        ...
        if (loopTop()) {
            ...
            if (getResponse().getApiId() == apiId) {
                ...
                case ZBTxStatusResponse::API_ID: {
                    ...
                    bool (*f)(ZBTxStatusResponse &, uintptr_t) =
                        (bool (*)(ZBTxStatusResponse &, uintptr_t))func;
                ...
                case ZBRxResponse::API_ID: {
                    ...
                    bool (*f)(ZBRxResponse &, uintptr_t) =
                        (bool (*)(ZBRxResponse &, uintptr_t))func;
                ...
                case ZBExplicitRxResponse::API_ID: {
                    ...
                    bool (*f)(ZBExplicitRxResponse &, uintptr_t) =
                        (bool (*)(ZBExplicitRxResponse &, uintptr_t))func;
                ...
                case ZBRxIoSampleResponse::API_ID: {
                    ...
                    bool (*f)(ZBRxIoSampleResponse &, uintptr_t) =
                        (bool (*)(ZBRxIoSampleResponse &, uintptr_t))func;
                ...
                case TxStatusResponse::API_ID: {
                    ...
                    bool (*f)(TxStatusResponse &, uintptr_t) =
                        (bool (*)(TxStatusResponse &, uintptr_t))func;
                ...
                case Rx16Response::API_ID: {
                    ...
                    bool (*f)(Rx16Response &, uintptr_t) =
                        (bool (*)(Rx16Response &, uintptr_t))func;
                ...
                case Rx64Response::API_ID: {
                    ...
                    bool (*f)(Rx64Response &, uintptr_t) =
                        (bool (*)(Rx64Response &, uintptr_t))func;
                ...
                case Rx16IoSampleResponse::API_ID: {
                    ...
                    bool (*f)(Rx16IoSampleResponse &, uintptr_t) =
                        (bool (*)(Rx16IoSampleResponse &, uintptr_t))func;
                ...
                case Rx64IoSampleResponse::API_ID: {
                    ...
                    bool (*f)(Rx64IoSampleResponse &, uintptr_t) =
                        (bool (*)(Rx64IoSampleResponse &, uintptr_t))func;
                ...
                case ModemStatusResponse::API_ID: {
                    ...
                    bool (*f)(ModemStatusResponse &, uintptr_t) =
                        (bool (*)(ModemStatusResponse &, uintptr_t))func;
                ...
                case AtCommandResponse::API_ID: {
                    ...
                    bool (*f)(AtCommandResponse &, uintptr_t) =
                        (bool (*)(AtCommandResponse &, uintptr_t))func;
                ...
                case RemoteAtCommandResponse::API_ID: {
                    RemoteAtCommandResponse *r =
                        (RemoteAtCommandResponse *)response;
                    bool (*f)(RemoteAtCommandResponse &, uintptr_t) =
                        (bool (*)(RemoteAtCommandResponse &, uintptr_t))func;
