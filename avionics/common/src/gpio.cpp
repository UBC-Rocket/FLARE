...
void initPins(void) {
    ...
    Hal::digitalWrite(Pin::POWER_LED, Hal::PinDigital::PIN_HIGH);

    /* Initialize and startup flight status LEDs */
    Hal::pinMode(Pin::FLIGHT_LED, Hal::PinMode::OUTPUT);
    Hal::digitalWrite(Pin::FLIGHT_LED, Hal::PinDigital::PIN_LOW);
    ...
    //     Hal::digitalWrite(Pin::IGNITOR, Hal::PinDigital::PIN_LOW);
    ...
    //     Hal::digitalWrite(Pin::MAIN_CONTINUITY_TEST, Hal::PinDigital::PIN_LOW);
    ...
    //     Hal::digitalWrite(Pin::DROGUE_IGNITOR, Hal::PinDigital::PIN_LOW);
    ...
    //     Hal::digitalWrite(Pin::DROGUE_CONTINUITY_TEST, Hal::PinDigital::PIN_LOW);
...
// #ifdef POW
//     Hal::digitalWrite(DROGUE_IGNITOR_PIN, Hal::PinDigital::PIN_HIGH);
...
//     Hal::digitalWrite(DROGUE_IGNITOR_PIN, Hal::PinDigital::PIN_LOW);
// #endif // POW
// }
...
//     Hal::digitalWrite(IGNITOR_PIN, Hal::PinDigital::PIN_HIGH);
...
//     Hal::digitalWrite(IGNITOR_PIN, Hal::PinDigital::PIN_LOW);
// }
 ...
 */
// bool continuityCheck(void) {
//     Hal::digitalWrite(CONTINUITY_CHECK_PIN, Hal::PinDigital::PIN_HIGH);
//     Hal::sleep_us(CONTINUITY_CHECK_DELAY);

//     int main_continuity = Hal::analogRead(CONTINUITY_CHECK_ADC);
//     Hal::digitalWrite(CONTINUITY_CHECK_PIN, Hal::PinDigital::PIN_LOW);
...
// #ifdef POW
//     Hal::digitalWrite(DROGUE_CONTINUITY_CHECK_PIN, Hal::PinDigital::PIN_HIGH);
//     Hal::sleep_us(CONTINUITY_CHECK_DELAY);

//     int drogue_continuity = Hal::analogRead(DROGUE_CONTINUITY_CHECK_ADC);
//     Hal::digitalWrite(DROGUE_CONTINUITY_CHECK_PIN, Hal::PinDigital::PIN_LOW);
