...
// T should be some floating point type, since a number of functions have their
// parameters passed in by value and return by value as well.
template <typename T> class ExponentialMovingAvg {
  public:
    /**
